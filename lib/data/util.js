 ...
 */
export const makeSwatchTable = (swatches, filterPredicate = null) => {
 ...
 */
export const pickSwatches = (predicate, swatchesList) => {
 ...
 */
export const getAllControlCodes = lookupTables => {
 ...
 */
export const makeCodeTable = colorSet => {
 ...
 */
export const makePlayerTable = colorSet => {
