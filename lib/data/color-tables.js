...
const idTableSwatches = objectFlip(colorDefinitions.swatchIDs.filter(swatch => swatch))
...
const allCodes = collectAllCodes([colorDefinitions.briefingMessage, colorDefinitions.textMessage])
