...
const {swatchTable} = require('../data')
 ...
 */
const convertToObject = (input, codeTable, colorSet, controlCodes, wrappingSwatch = null) => {
  const buffer = []
 ...
 */
const objectConverter = (codeTable, colorSet, controlCodes, defaultWrappingSwatchName) => (input, wrappingSwatchName) => {
