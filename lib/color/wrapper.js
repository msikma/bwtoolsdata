...
import {convertIngameText, convertIngameChat, convertBriefingText, convertMapName, convertChatMessage} from './interface.js'
import {convertObjectToString} from './convert.js'
import {swatchDefinitions, controlDefinitions} from '../data/index.js'
 ...
 */
export const createConversionWrappers = (wrapperFactory, swatches = swatchDefinitions, specialCodes = controlDefinitions) => {
 ...
 */
export const createTextConverter = (wrapperFactory, swatches = swatchDefinitions, specialCodes = controlDefinitions) => {
