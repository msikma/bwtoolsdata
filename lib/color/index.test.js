...
import {createTextConverter, convertMapName, stripEscapeCodes} from './index.js'
...
const testFixtures = {
  ...
  outputStripped: {
    polypoidMapName: `Polypoid 1.65`,
    polypoidMapDescription: 'Usually harmless.\r\nHowever, there is a small risk of malignancy.\r\n\r\nCreated by KM-\r\nReleased 2021.3.11.',
    lemonMapName: 'Lemon 0.95',
    goodnight131MapName: 'GOOD NIGHT 1.31',
    goodnight13MapName: '(4)GOOD NIGHT',
    eclipseMapName: 'Eclipse 1.2',
    ascensionMapName: 'Ascension 1.0'
  },
  outputString: {
...
describe(`color conversion functions`, () => {
  ...
  describe(`stripEscapeCodes()`, () => {
    it(`returns a string cleaned of all escape codes`, () => {
      for (const testItem of testFixtureNames) {
        expect(stripEscapeCodes(testFixtures.input[testItem])).toStrictEqual(testFixtures.outputStripped[testItem])
      }
    })
  })
})
