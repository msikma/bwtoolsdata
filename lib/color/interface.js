...
import {objectConverter} from './convert.js'
import {colorDefinitions, swatchTable, codeTableIngame, codeTableBriefing, allCodes, idTablePlayer, gameTypeDefinitions} from '../data/index.js'
 ...
 */
export const getSwatchFromSlotID = id => {
 ...
 */
export const getSwitchedSwatch = (teamID, matchTypeID) => {
 ...
 */
export const getColorFromSwatch = swatch => {
 ...
 */
export const stripEscapeCodes = str => {
 ...
 */
export const convertIngameChat = objectConverter(codeTableIngame, colorDefinitions.ingameText, allCodes, 'ingameGreen')

/**
 * Converts an in-game text string into an object.
 */
export const convertIngameText = objectConverter(codeTableIngame, colorDefinitions.ingameText, allCodes)

/**
 * Converts a briefing text string into an object.
 */
export const convertBriefingText = objectConverter(codeTableBriefing, colorDefinitions.briefingText, allCodes)

/**
 * Converts a map name string into an object.
 */
export const convertMapName = convertBriefingText

/**
 * Converts a chat message with player name into an object.
 */
export const convertChatMessage = (playerName, playerSwatch, message) => {
  return [
